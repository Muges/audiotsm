...
"""
The :mod:`~audiotsm.gstreamer.wsola` module implements an audio filters
...
from audiotsm import wsola, __version__
...
class WSOLA(GstAudio.AudioFilter):
    ...
    def do_setup(self, audioinfo):
        ...
        self._tsm = wsola(audioinfo.channels, speed=1.5)
        self._position = 0
        return True
